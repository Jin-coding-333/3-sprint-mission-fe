...
export default function HeroSection() {
  return (
    <section className={HeroSectionStyle.container}>
      ...
      <div
        className={cn(
          HeroSectionStyle.content.sm,
          HeroSectionStyle.content.md,
          HeroSectionStyle.content.lg
        )}
      >
        {/* Text with Button Box */}
        <div
          className={cn(
            HeroSectionStyle.textWithButtonBox.sm,
            HeroSectionStyle.textWithButtonBox.md,
            HeroSectionStyle.textWithButtonBox.lg
          )}
        >
          <h1
            className={cn(
              HeroSectionStyle.text.sm,
              HeroSectionStyle.text.md,
              HeroSectionStyle.text.lg,
          ...
          <Button
            ...
            className={cn(HeroSectionStyle.button, 'text-xl')}
          >
            구경하러 가기
          </Button>
        </div>
...
const HeroSectionStyle = {
  ...
  content: {
    ...
    md: 'md:gap-[211px] md:w-[744px] md:pt-[99px] md:h-[540px]',
